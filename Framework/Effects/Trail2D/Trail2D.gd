...
# Distance in pixels between vertices. Higher resolution gets a more detailed trail.
...
# Optional path to the target node to follow. If not set the instace follows its parent.
...
func _process(delta: float):
	...
	# Adding new points as necessary.
